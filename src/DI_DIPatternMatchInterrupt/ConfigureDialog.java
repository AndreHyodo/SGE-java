...
class DiPortUI extends JPanel{
	...
	public DiPortUI(int index, JPanel parrent, Point location, ImageIcon[] image, byte state) {
		...
		highBytes.setBounds(location.x, location.y, 115, 30);
		...
		lowBytes.setBounds(location.x + 125, location.y, 115, 30);
		...
		lblHexValue.setBounds(location.x + 250, location.y + 4, 35, 23);
