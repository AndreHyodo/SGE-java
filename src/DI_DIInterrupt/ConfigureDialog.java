...
public class ConfigureDialog extends JDialog {
	...
	public ConfigureDialog(DIInterrupt parrent ) {
		...
		scrollPanel = new JScrollPane(portPanel);
		scrollPanel.setBorder(new LineBorder(new Color(0, 0, 0)));
		scrollPanel.setBounds(20, 96, 325, 122);
		contentPanel.add(scrollPanel);
		
		btnOK = new JButton("OK");
		btnOK.setBounds(145, 235, 69, 23);
		btnOK.addActionListener(new ButtonOKActionListener());
		contentPanel.add(btnOK);
		
		JButton btnCancel = new JButton("Cancel");
		btnCancel.setBounds(247, 235, 75, 23);
		...
		lblNewLabel.setBounds(20, 53, 128, 15);
		contentPanel.add(lblNewLabel);
		
		JLabel lblNewLabel_1 = new JLabel("CH#7");
		lblNewLabel_1.setBounds(79, 75, 41, 15);
		contentPanel.add(lblNewLabel_1);
		
		JLabel label = new JLabel("#0");
		label.setBounds(315, 75, 30, 15);
