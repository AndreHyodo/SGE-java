...
// public class bk extends JFrame implements ActionListener {
...
// 		allPanel = new JPanel();
// 		// Default size
// 		allPanel.setPreferredSize(new Dimension(100, 1080));
...
// 		JLabel lblNewLabel_3 = new JLabel("Aqui");
...
// 		DiPorts = new DioPortUI_bk[portCount];
// 		Point location = new Point(10, 10);
// 		allPanel.removeAll();
// 		allPanel.repaint();
		
// 		for (int i = 0; i < portCount; i++) {
// 			DiPorts[i] = new DioPortUI_bk(i, allPanel, location, imageIcon, (byte) 0);
// 			if (i % 2 == 0) {
// 				location.y += 40;
// 			} else {
// 				location.y += 55;
