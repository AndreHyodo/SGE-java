...
public class DioPortUI_bk extends JPanel{
	...
	public DioPortUI_bk(int index, JPanel parrent, Point location, ImageIcon[] image, byte state) {
		key = index;
		this.state = state;
		imageIcon = image;
	...
	class MouseClickListener extends MouseAdapter{
		...
		public void mouseClicked(MouseEvent e) {
			...
			if (isEditable) {
				...
				if(listener != null){
					listener.StateChangeAction(DioPortUI_bk.this);
				}
			}
		}
	}
